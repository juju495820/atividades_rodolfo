# Mais Impressão - Práticas de digitação e alguns conceitos sobre impressão de strings
...
#Aquela vírgula no fim. tente removê-la para ver o que acontece
print(end1 + end2 + end3 + end4 + end5 + end6, end='') #concatena os valores das variáveis 
